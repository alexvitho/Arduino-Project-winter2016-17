...
namespace GuzzlerMobileApp.views
{
    ...
    public sealed partial class realTimeMeasure : Page, INotifyPropertyChanged
    {
        ...
        private void TimerOnTick(object sender, object eventArgs)
        {
            ...
            string partitionFilter = TableQuery.GenerateFilterCondition("PartitionKey", QueryComparisons.Equal, "GD002-17"); // should be guzzlerId
