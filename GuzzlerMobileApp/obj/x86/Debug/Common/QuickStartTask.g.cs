#pragma checksum "C:\Users\Alex\Desktop\GuzzlerMobileApp_Windows_CS\GuzzlerMobileApp\Common\QuickStartTask.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "5377A322D4008AD5BCECCC45C5145AED"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace GuzzlerMobileApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::GuzzlerMobileApp.QuickStartTask dataRoot;
            ...
            public void SetDataRoot(global::GuzzlerMobileApp.QuickStartTask newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::GuzzlerMobileApp.QuickStartTask obj, int phase)
            {
            ...
            private class QuickStartTask_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_Title(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::GuzzlerMobileApp.QuickStartTask obj = sender as global::GuzzlerMobileApp.QuickStartTask;
        if (obj != null)
        {
        ...
        if (obj != null)
        {
            bindings.Update_Number(obj.Number, DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::GuzzlerMobileApp.QuickStartTask obj)
                {
                    QuickStartTask_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.TitleProperty, tokenDPC_Title);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.DescriptionProperty, tokenDPC_Description);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.NumberProperty, tokenDPC_Number);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_Title = obj.RegisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.TitleProperty, DependencyPropertyChanged_Title);
                            tokenDPC_Description = obj.RegisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.DescriptionProperty, DependencyPropertyChanged_Description);
                            tokenDPC_Number = obj.RegisterPropertyChangedCallback(global::GuzzlerMobileApp.QuickStartTask.NumberProperty, DependencyPropertyChanged_Number);
                        }
                    }
                }
            }
